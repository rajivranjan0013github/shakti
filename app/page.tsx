          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative mt-8 lg:mt-0">
              <Image
                ...
                className="rounded-2xl shadow-xl shadow-white w-full h-auto"
                height="600"
                src="/s-1.png"
                width="600"
                priority
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="text-center p-4">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">500+</div>
              <div className="text-sm sm:text-base text-gray-600">Satisfied Clients</div>
            </div>
            <div className="text-center p-4">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">15+</div>
